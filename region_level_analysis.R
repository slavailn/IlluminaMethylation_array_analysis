...
design <- model.matrix(~Trait + Gender + Age + Smoking_status, 
                       data=targets)
head(design)
...
results.ranges
save(results.ranges, file = "GSE42861_DMRs_GRanges.RData")
...
pdf("DMR4_DMR_memory_cells.pdf", width = 10, height = 8)
